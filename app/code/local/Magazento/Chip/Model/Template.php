...
class Magazento_Chip_Model_Template extends Mage_Core_Model_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Magazento/Chip/import/data.xml';
    ...
    public function setDefaultSettings($scope, $store) {
        ...
        $defaults->loadFile(Mage::getBaseDir().'/app/code/local/Magazento/Chip/etc/config.xml');
